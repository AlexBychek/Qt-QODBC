...
QT_MOC_LITERAL(1, 6, 9), // "pushquery"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(4, 39, 9), // "getresult"
QT_MOC_LITERAL(5, 49, 3) // "str"

    },
    "Query\0pushquery\0\0on_pushButton_clicked\0"
    "getresult\0str"
};
...
void Query::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pushquery((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->on_pushButton_clicked(); break;
        case 2: _t->getresult((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Query::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Query::pushquery)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Query::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_Query.data,
    qt_meta_data_Query,
    qt_static_metacall,
    nullptr,
    nullptr
...
// SIGNAL 0
void Query::pushquery(QString _t1)
{
